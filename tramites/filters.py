...
class CasoInternoFilter(django_filters.FilterSet):
    ...
    def filter_buscar(self, queryset, _name, value):
        ...
        query = (
            ...
            | Q(generadores_adicionales__icontains=value)
            | Q(receptores_adicionales__icontains=value)
            | Q(trabajadores_manuales__icontains=value)
            ...
            | Q(tramites_relacionados__generador_nombre__icontains=value)
            | Q(tramites_relacionados__generador_iniciales__icontains=value)
            | Q(tramites_relacionados__receptor_nombre__icontains=value)
            | Q(tramites_relacionados__receptor_iniciales__icontains=value)
            | Q(tramites_relacionados__generadores_adicionales__icontains=value)
            | Q(tramites_relacionados__receptores_adicionales__icontains=value)
